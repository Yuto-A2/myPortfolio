...
export default function Studied() {
    ...
    return (
        <>
            ...
            <div ref={ref} className="studyContainer" id='animation'>
                {inView && (
                    <>
            ...
            <div ref={ref2} className="studyContainer" id='animation2'>
                {inView2 && (
                    <>
                        <div className="studiedBox">
            ...
            <div ref={ref3} className="studyContainer" id='animation3'>
                {inView3 && (
                    <>
                        <div className="studiedBox">
